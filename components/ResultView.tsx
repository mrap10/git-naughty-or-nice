...
export default function ResultView({ stats, onReset }: ResultViewProps) {
    ...
    return (
        ...
        >
            ...
            <div ref={certificateRef} className="w-full bg-stone-100 text-slate-900 p-6 rounded-sm relative overflow-hidden transform rotate-1 hover:rotate-0 transition-transform duration-500 shadow-[0_0_50px_rgba(255,255,255,0.1)]">
