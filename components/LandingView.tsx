...
export default function LandingView({ username, setUsername, handleSubmit }: LandingViewProps) {
    return (
        ...
        >   
            ...
            <Link href="https://github.com/mrap10/naughty-or-nice" target="_blank" rel="noopener noreferrer" className="fixed top-6 right-4 px-4 py-1 text-red-500 bg-slate-800 hover:bg-slate-900 transition-colors flex items-center gap-1 font-mono font-bold rounded-lg z-50">
                ⭐ on Github
            </Link>
