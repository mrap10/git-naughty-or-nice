...
export default function LandingView({ username, setUsername, handleSubmit }: LandingViewProps) {
    return (
        ...
        >   
            ...
            <Link href="https://github.com/mrap10/naughty-or-nice" target="_blank" rel="noopener noreferrer" className="font-jetbrains text-sm fixed top-6 right-4 px-4 py-1 text-red-500 bg-slate-800 hover:bg-slate-900 transition-colors flex items-center gap-1 font-semibold rounded-lg z-50">
                ⭐ on Github
            </Link>
                ...
                <form onSubmit={handleSubmit} className="relative group w-full">
                    ...
                    <div className="relative p-3 flex justify-between items-center bg-black rounded-lg border border-slate-800">
                        <div className="flex gap-2 items-center font-mono w-full">
                            <p className="text-slate-500 select-none hidden sm:block font-jetbrains text-sm">github.com/</p>
                            <input 
                                type="text"
                                value={username}
            ...
            <footer className="absolute bottom-4 w-full text-center font-jetbrains">
                <p className="text-slate-500 text-sm">
                    Made with ❤️ by <Link href="https://github.com/mrap10" target="_blank" rel="noopener noreferrer" className="text-red-500 hover:underline">mrap10</Link>
                </p>
            </footer>
        </motion.div>
    )
